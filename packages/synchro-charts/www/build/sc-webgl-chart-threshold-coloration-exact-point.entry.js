...
const ScWebglChartThresholdColorationExactPoint = class {
    constructor(hostRef) {
...
export { ScWebglChartThresholdColorationExactPoint as sc_webgl_chart_threshold_coloration_exact_point };
