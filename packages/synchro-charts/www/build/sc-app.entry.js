...
const App = class {
    ...
    render() {
        return (h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, routes.map(r => (h("stencil-route", { url: r.url, component: r.component, exact: true }))))));
    }
};

export { App as sc_app };
