...
export declare const isValid: <T>(predicate: (t: Partial<T>) => boolean) => (t: Partial<T>) => t is T;
export declare const isSupportedDataType: (supportsString: boolean) => ({ dataType }: {
    dataType: DataType;
}) => boolean;
export declare const isNumberDataStream: (stream: DataStream) => stream is DataStream<number>;
export declare const isNumber: <T>(val: number | T) => val is number;
