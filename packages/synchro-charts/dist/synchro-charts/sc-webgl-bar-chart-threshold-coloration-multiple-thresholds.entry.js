...
const ScWebglBarChartThresholdMultipleThresholds = class {
    constructor(hostRef) {
...
export { ScWebglBarChartThresholdMultipleThresholds as sc_webgl_bar_chart_threshold_coloration_multiple_thresholds };
