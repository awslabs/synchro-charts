...
const ScWebglChartThresholdColorationMultipleDataStream = class {
    constructor(hostRef) {
...
export { ScWebglChartThresholdColorationMultipleDataStream as sc_webgl_chart_threshold_coloration_multiple_data_stream };
