...
import { S as ScaleType } from './constants-4b21170a.js';
import './index-25df4638.js';
import { t as time, l as linear$2, a as log, e as event$1, s as select$1 } from './index-af4372bf.js';
 ...
 */
const createScales = ({ viewPort: { start, end, yMin, yMax }, size: { width, height }, scale: { xScaleType, yScaleType }, }) => ({
...
const getTransformFromDates = ({ prevXScale, prevDates, currDates, }) => {
    ...
    return identity$1.translate(t, 0).scale(k); // NOTE: Only supporting x brushing for now.
};
/**
...
class Zoom {
    ...
    init() {
        ...
        select$1(container).call(this.zoomBehavior);
    }
    ...
    updateSize({ xMin, xMax, yMin, yMax, }) {
        ...
        this.setTransform(identity$1.translate(x * xRatio, y).scale(k));
...
const ScGestureHandler = class {
    constructor(hostRef) {
        ...
        this.initiateTransform = (startPx, endPx) => {
            ...
            const transitionContainer = select$1(this.getZoomContainer())
                .transition()
                .duration(TRANSITION_DURATION);
...
export { ScGestureHandler as sc_gesture_handler };
