...
const ScWebglBarChartFastViewport = class {
    constructor(hostRef) {
    ...
    render() {
        return (h("div", null, h("button", { id: "change-viewport", onClick: this.changeViewport }, "Change Viewport"), h("br", null), h("br", null), h("div", { id: "chart-container", style: { border: '1px solid lightgray', height: '500px', width: '500px' } }, h("sc-bar-chart", { dataStreams: [
                {
                    id: 'test',
                    color: '#264653',
                    name: 'test stream',
...
export { ScWebglBarChartFastViewport as sc_webgl_bar_chart_fast_viewport };
