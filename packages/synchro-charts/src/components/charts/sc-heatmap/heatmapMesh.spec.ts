...
describe('create bucket mesh', () => {
  ...
  it('increase buffer size when there are more buckets than the minimum buffer size', () => {
    ...
    // bucket Colors
    expect(mesh.geometry.attributes.color.array[0]).toBe(colorPalette.r[0]);
    expect(mesh.geometry.attributes.color.array[1]).toBe(colorPalette.g[0]);
    expect(mesh.geometry.attributes.color.array[2]).toBe(colorPalette.b[0]);
