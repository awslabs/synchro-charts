...
const statusGridSpecPage = async (propOverrides: Partial<Components.MonitorStatusGrid> = {}) => {
  const page = await newSpecPage({
    components: [MonitorGrid, MonitorStatusGrid, MonitorWidgetGrid, MonitorGridTooltip],
    html: '<div></div>',
    supportsShadowDom: false,
  });
  const statusGrid = page.doc.createElement('monitor-status-grid') as CustomHTMLElement<Components.MonitorStatusGrid>;
  const props: Partial<Components.MonitorStatusGrid> = {
    widgetId: WIDGET_ID,
...
describe('when enabled', () => {
  it('renders a grid cell', async () => {
    ...
    const cells = statusGrid.querySelectorAll('monitor-status-cell');
  ...
  it('passes down a default labelsConfig when none provided', async () => {
    ...
    const cell = statusGrid.querySelector('monitor-status-cell') as HTMLMonitorStatusCellElement;
  ...
  it('does not render a help icon', async () => {
    ...
    expect(statusGrid.querySelector('monitor-help-tooltip')).toBeNull();
  });
...
describe('when disabled', () => {
  ...
  it('renders a help icon', async () => {
    ...
    expect(statusGrid.querySelector('monitor-help-tooltip')).not.toBeNull();
  });
});
