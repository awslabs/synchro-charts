...
describe('bar chart', () => {
  it('renders a single bar', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/single-bar`);
  ...
  it('renders a colored bar as red', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/single-colored-bar`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders multiple data streams as two bars', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/multiple-bars`);
    cy.viewport(200, 200);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
...
describe('line chart', () => {
  it('renders colored point as red', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/colored-point`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders circle correctly with anti-aliasing', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/circle-point-shaders`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders straight line segment between two dots', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/straight-line-segment`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders straight line segment between two dots as the color purple', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/straight-line-segment-colored`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders angled line segment between two dots with anti-aliasing', () => {
    cy.visit(`${root}/tests/sc-webgl-chart/angled-line-segment`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders multiple data streams as disconnected lines', () => {
    ...
    cy.visit(`${root}/tests/sc-webgl-chart/multiple-lines`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
  ...
  it('renders multiple data streams as disconnected lines, with lines and points overlapping', () => {
    ...
    cy.visit(`${root}/tests/sc-webgl-chart/multiple-lines-overlapping`);
    cy.viewport(CHART_SIZE.width, CHART_SIZE.height);
    cy.wait(WAIT_MS);
    cy.get('#test-container').matchImageSnapshotOnCI();
  });
